...
class EmpleadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empleado" do
    assert_difference('Empleado.count') do
      post empleados_url, params: { empleado: { nombre: @empleado.nombre, nombre_puesto: @empleado.nombre_puesto, rfc: @empleado.rfc, sucursal_id: @empleado.sucursal_id } }
    end
  ...
  test "should update empleado" do
    patch empleado_url(@empleado), params: { empleado: { nombre: @empleado.nombre, nombre_puesto: @empleado.nombre_puesto, rfc: @empleado.rfc, sucursal_id: @empleado.sucursal_id } }
